...
housing = read_table("https://archive.ics.uci.edu/static/public/10/housing.zip", col_names = FALSE)
...
# Compared to the original housing training data, there are like 61 more X variables

# Estimation using the LASSO method
...
# Optimal λ is 0.00139
# In sample RSME 0.0677   
# Out of sample RSME 0.170


# Estimation using the ridge method
...
# Optimal λ is 0.0233
# In sample RSME 0.0682
# Out of sample RSME 0.173
